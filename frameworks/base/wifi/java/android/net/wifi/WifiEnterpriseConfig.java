...
public class WifiEnterpriseConfig implements Parcelable {
    ...
    ///M: WAPI @{
    /** @hide */
    public static final String CA_CERT2_PREFIX
        = KEYSTORE_URI + Credentials.WAPI_SERVER_CERTIFICATE;
    private static final String CLIENT_CERT2_PREFIX
        = KEYSTORE_URI + Credentials.WAPI_USER_CERTIFICATE;
    /** @hide */
    public static final String USER_PRIVATE_KEY2_PREFIX
        = KEYSTORE_URI + Credentials.WAPI_USER_CERTIFICATE;
    ///@}
    /** @hide */
