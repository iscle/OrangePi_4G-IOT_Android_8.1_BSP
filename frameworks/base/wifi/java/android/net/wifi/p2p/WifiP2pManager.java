    ...
    public static class Channel implements AutoCloseable {
        ...
        protected void finalize() throws Throwable {
            try {
                ...
                //In low end deivce, GC happens frequently.
                //The p2p connection is broken when GC occurs.
                //This does not make sense for end user.
                //So we should avoid p2p disconnection when GC.
                //close();
            } finally {
                super.finalize();
            }
