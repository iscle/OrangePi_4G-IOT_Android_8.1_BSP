...
public class WifiManager {
    ...
    public boolean startScan(WorkSource workSource) {
        Log.d(TAG, "startScan, uid:" + Process.myUid());
        try {
    ...
    */
    ...
    public void connect(WifiConfiguration config, ActionListener listener) {
        ...
        Log.d(TAG, "connect with config, SSID:" + config.SSID + ", uid:" + Process.myUid());
    ...
    public void connect(int networkId, ActionListener listener) {
        Log.d(TAG, "connect with netId " + networkId +  ", uid:" + Process.myUid());
    ...
    public void save(WifiConfiguration config, ActionListener listener) {
        if (config == null) throw new IllegalArgumentException("config cannot be null");
        Log.d(TAG, "save with config, SSID:" + config.SSID + ", uid:" + Process.myUid());
    ...
    public void forget(int netId, ActionListener listener) {
        Log.d(TAG, "forget netId " + netId + ", uid:" + Process.myUid());
    ...
    public void disable(int netId, ActionListener listener) {
        Log.d(TAG, "disable netId " + netId +  ", uid:" + Process.myUid());
        if (netId < 0) throw new IllegalArgumentException("Network id cannot be negative");
    ...
    public void startWps(WpsInfo config, WpsCallback listener) {
        Log.d(TAG, "startWps, uid:" + Process.myUid());
        if (config == null) throw new IllegalArgumentException("config cannot be null");
    ...
    public void cancelWps(WpsCallback listener) {
        Log.d(TAG, "cancelWps, uid:" + Process.myUid());
    ...
    public void enableWifiConnectivityManager(boolean enabled) {
        Log.d(TAG, "enableWifiConnectivityManager " + enabled + ", uid:" + + Process.myUid());
        try {
