...
public class Tethering extends BaseNetworkObserver {
    ...
    private static final boolean IS_USER_BUILD =
        "user".equals(android.os.Build.TYPE) || "userdebug".equals(android.os.Build.TYPE);
    private final static boolean DBG = true;
    private final static boolean VDBG = IS_USER_BUILD ? Log.isLoggable(TAG, Log.VERBOSE)
    ...
    public Tethering(Context context, INetworkManagementService nmService,
        ...
        /// Support Tethering add-on mechanism @{
        mMtkTethering = getMtkTethering(context);
        /// @}
        ...
        protected void setUpstreamNetwork(NetworkState ns) {
            ...
            if (ns != null && ns.linkProperties != null) {
                ...
                if (ipv4Default != null) {
                    ...
                    /// M: Support IPv6 only upstreaming. @{
                    iface = hasIPv6Iface(ns);
                    /// @}
                }
            }
    ...
    private String hasIPv6Iface(NetworkState ns) {
        String iface = null;
        if (mMtkTethering != null) {
            try {
                java.lang.reflect.Method method =
                        mMtkTethering.getClass().getMethod("hasIPv6Iface", NetworkState.class);
                method.setAccessible(true);
                iface = (String) method.invoke(mMtkTethering, ns);
            } catch (Exception e) {
                mLog.e("hasIPv6Iface method error:" + e);
            }
        }
        return iface;
    }
