...
public final class ProcessRecord {
    ...
    public boolean killedByAm;  // True when proc has been killed by activity manager, not for RAM
    public boolean killed;      // True once we know the process has been killed
    ...
    public ProcessRecord(BatteryStatsImpl _batteryStats, ApplicationInfo _info,
