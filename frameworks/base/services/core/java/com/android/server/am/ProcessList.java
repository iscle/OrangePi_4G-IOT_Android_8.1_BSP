...
public final class ProcessList {
    ...
    /// M: add for higher LMKD oomadj levels for browser @{
    static final byte LMK_MEDLOOSEN = 3;
    /// @}
    ...
    /*
     * {@hide}
     * Add for higher LMKD oomadj levels
     */
    public static final void medLoosen(int OomAdjLeves) {
        ByteBuffer buf = ByteBuffer.allocate(4 * 2);
        buf.putInt(LMK_MEDLOOSEN);
        buf.putInt(OomAdjLeves);
        writeLmkd(buf);
    }
}
