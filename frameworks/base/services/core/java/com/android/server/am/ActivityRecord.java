...
public final class ActivityRecord extends ConfigurationContainer implements
    ...
    public ProcessRecord app;      // if non-null, hosting application
    ...
    private void reportLaunchTimeLocked(final long curTime) {
        ...
        if (SHOW_ACTIVITY_START_TIME) {
            ...
            service.sMtkSystemServerIns.addBootEvent("AP_Launch: " + shortComponentName +
                    " " + thisTime + "ms");
            /// M: @}
        }
    ...
    public void onWindowsVisible() {
        ...
        /// M: onWindowsVisible @{
        service.mAmsExt.onWindowsVisible();
        /// M: onWindowsVisible @}
    }
    ...
    void relaunchActivityLocked(boolean andResume, boolean preserveWindow) {
        ...
        if (andResume) {
            ...
            service.mAmsExt.onAfterActivityResumed(this);
            /// M: onAfterActivityResumed @}
