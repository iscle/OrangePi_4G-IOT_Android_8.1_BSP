...
///M: Shutdown animation mechanism @{
...
public class ShutdownThread extends Thread {
    ...
    // state tracking
    ///M: Modify type to "Protected" for Shutdown animation mechanism @{
    protected static final Object sIsStartedGuard = new Object();
    ...
    ///M: Shutdown animation mechanism @{
    protected static ShutdownThread sInstance = MtkSystemServiceFactory.getInstance()
            .makeMtkShutdownAnimationThread();
    /// @}
    ...
    protected PowerManager.WakeLock mCpuWakeLock;
    ...
    ///M: Public ShutdownThread() for animation @{
    ...
    private static ProgressDialog showShutdownDialog(Context context) {
        ...
        ///M: added for Shutdown Animation @{
        if(!sInstance.showCustomizedShutdownAnimation(pd, context))
        {
            pd.show();
        }
        /// @}
    ...
    private static void beginShutdownSequence(Context context) {
        ...
        ///M: added for Shutdown Animation @{
        if(!sInstance.customizedShutdownSequence())
        {
    ...
    ///M: added for Shutdown Animation @{
    protected boolean showCustomizedShutdownAnimation(ProgressDialog pd, Context c)
    {
        return false;
    }

    protected boolean customizedShutdownSequence()
    {
        return false;
    }

    protected void shutdownAnimationService()
    {

    }

    protected boolean isCustomizedShutdown()
    {
        return false;
    }
    /// @}
