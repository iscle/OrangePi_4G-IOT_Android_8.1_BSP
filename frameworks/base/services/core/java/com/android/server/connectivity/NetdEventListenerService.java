...
public class NetdEventListenerService extends INetdEventListener.Stub {
    ...
    /// M: Add by Mediatek for CTA requirement about Celluar data control.
    private INetdEventListener mMtkNetdEventListener;
    ...
    public synchronized void onDnsEvent(int netId, int eventType, int returnCode, int latencyMs,
        ...
        if (mMtkNetdEventListener != null) {
            mMtkNetdEventListener.onDnsEvent(netId, eventType, returnCode, latencyMs,
                    hostname, ipAddresses, ipAddressesCount, uid);
        }
        /// @}
    }
    ...
    public synchronized void onConnectEvent(int netId, int error, int latencyMs, String ipAddr,
        ...
        /// Support celluar data control by CTA. @{
        if (mMtkNetdEventListener != null) {
            mMtkNetdEventListener.onConnectEvent(netId, error, latencyMs, ipAddr,
                    port, uid);
        }
        /// @}
    ...
    /// M: Add by Mediatek for CTA requirement about Celluar data control.
    public void setMtkNetdEventListener(INetdEventListener listener) {
        mMtkNetdEventListener = listener;
    }
}
