...
public class NetworkStatsService extends INetworkStatsService.Stub {
    ...
    protected static final boolean LOGV = true;
    ...
    public static NetworkStatsService create(Context context,
        ...
        /// M: Disable NTP function for Data usage for specific network envionment.
        TrustedTime time = NtpTrustedTime.getInstance(context);
        try {
            String jarPath = "/system/framework/mediatek-framework-net.jar";
            String classPath = "com.mediatek.net.ntp.MtkFakeNtpTrustedTime";
            dalvik.system.PathClassLoader pcLoader = new dalvik.system.PathClassLoader(
                    jarPath, context.getClassLoader());
            Class ntpClass = pcLoader.loadClass(classPath);
            java.lang.reflect.Method method = ntpClass.getDeclaredMethod(
                    "getInstance", Context.class);
            method.setAccessible(true);
            TrustedTime mtkTime = (TrustedTime) method.invoke(ntpClass, context);
            if (mtkTime != null) {
                Slog.d(TAG, "Disable NTP for data usage");
                time = mtkTime;
            }
        }  catch (Exception e) {
            Slog.e(TAG, "No MtkFakeNtpTrustedTime! Used AOSP for instead! %s", e);
        }
        // M: modify for customiztion of MtkNetworkStatsService.java
        /** M:
        ...
        try {
            ...
            Object mtkNetworkStats = (Object) clazzConstructfunc.newInstance(context,
                    networkManager, alarmManager, wakeLock, time,
        ...
        if (service == null) {
                ...
                wakeLock, time, TelephonyManager.getDefault(),
