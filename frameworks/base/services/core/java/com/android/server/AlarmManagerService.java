...
public class AlarmManagerService extends SystemService {
    ...
    protected static final boolean DEBUG_ALARM_CLOCK = localLOGV || false;
    static final boolean DEBUG_LISTENER_CALLBACK = localLOGV || false;
    protected static final boolean DEBUG_WAKELOCK = localLOGV || false;
    ...
    protected final class Batch {
        ...
        public boolean remove(final PendingIntent operation, final IAlarmListener listener) {
    ...
    protected static final class InFlight {
        ...
        public InFlight(AlarmManagerService service, PendingIntent pendingIntent, IAlarmListener listener,
    ...
    private void setImplLocked(Alarm a, boolean rebatching, boolean doValidate) {
        ...
        int whichBatch = ((supportAlarmGrouping()&&a.needGrouping == false)||
        ///@}
        ((a.flags&AlarmManager.FLAG_STANDALONE) != 0))
