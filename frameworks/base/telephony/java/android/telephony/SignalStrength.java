...
public class SignalStrength implements Parcelable {
    ...
    /** @hide */
    protected int mGsmSignalStrength; // Valid values are (0-31, 99) as defined in TS 27.007 8.5
    /** @hide */
    protected int mGsmBitErrorRate;   // bit error rate (0-7, 99) as defined in TS 27.007 8.5
    /** @hide */
    protected int mCdmaDbm;   // This value is the RSSI value
    /** @hide */
    protected int mCdmaEcio;  // This value is the Ec/Io
    /** @hide */
    protected int mEvdoDbm;   // This value is the EVDO RSSI value
    /** @hide */
    protected int mEvdoEcio;  // This value is the EVDO Ec/Io
    /** @hide */
    protected int mEvdoSnr;   // Valid values are 0-8.  8 is the highest signal to noise ratio
    /** @hide */
    protected int mLteSignalStrength;
    /** @hide */
    protected int mLteRsrp;
    /** @hide */
    protected int mLteRsrq;
    /** @hide */
    protected int mLteRssnr;
    /** @hide */
    protected int mLteCqi;
    /** @hide */
    protected int mLteRsrpBoost; // offset to be reduced from the rsrp threshold while calculating
                                // signal strength level
    /** @hide */
    protected int mTdScdmaRscp;

    /** @hide */
    protected boolean isGsm; // This value is set by the ServiceStateTracker onSignalStrengthResult
