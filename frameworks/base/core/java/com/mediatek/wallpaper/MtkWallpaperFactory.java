...
public class MtkWallpaperFactory {
    ...
    public static MtkWallpaperFactory getInstance() {
        if (null == sInstance) {
            String className = "com.mediatek.wallpaper.MtkWallpaperFactoryImpl";
            String classPackage = "/system/framework/mediatek-framework.jar";
            Class<?> clazz = null;
            try {
                PathClassLoader classLoader = new PathClassLoader(classPackage,
                        MtkWallpaperFactory.class.getClassLoader());
                clazz = Class.forName(className, false, classLoader);
                Constructor constructor = clazz.getConstructor();
                sInstance = (MtkWallpaperFactory) constructor.newInstance();
            } catch (Exception e) {
