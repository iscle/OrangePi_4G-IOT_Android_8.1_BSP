...
public final class Sensor {
    ...
    /**
     * A constant describing how far user walked.
     *
     * @internal
     * @hide
     * @deprecated
     ...
     */
    @Deprecated
    public static final int TYPE_PEDOMETER = 55;
    /**
     * @hide
     */
    @Deprecated
    ...
    /**
     * A constant describing the phone was put into pocket
     *
     * @internal
     * @hide
     *
     */
    public static final int TYPE_IN_POCKET = 56;
    /**
     * @hide
     */
    ...
    /**
     * A constant describing the phone's status, such as walking, running, on-bicycle and so on
     *
     * @internal
     * @hide
     * @deprecated
     ...
     */
    @Deprecated
    public static final int TYPE_ACTIVITY = 57;
    /**
     * @hide
     */
    @Deprecated
    ...
    /**
     * A constant describing walking navigation.
     *
     * @internal
     * @hide
     * @deprecated
     ...
     */
    @Deprecated
    public static final int TYPE_PDR = 58;
    /**
     * @hide
     */
    @Deprecated
    ...
    /**
     * A constant describing the phone when in free fall.
     *
     * @internal
     * @hide
     * @deprecated
     ...
     */
    @Deprecated
    public static final int TYPE_FREEFALL = 59;
    /**
     * @hide
     */
    @Deprecated
    ...
    /**
     * A constant describing the phone lies flat on a table.
     *
     * @internal
     * @hide
     *
     */
    public static final int TYPE_FLAT = 60;
    /**
     * @hide
     */
    public static final String STRING_TYPE_FLAT
        = "android.sensor.flat";

    /**
     * A constant describing the phone's surface face to the ground.
     *
     * @internal
     * @hide
     *
     */
    public static final int TYPE_FACE_DOWN  = 61;
    /**
     * @hide
     */
    ...
    /**
     * A constant describing the status when user shake the phone.
     *
     * @internal
     * @hide
     *
     */
    public static final int TYPE_SHAKE = 62;
    /**
     * @hide
     */
     ...
     *
     */
    public static final int TYPE_BRING_TO_SEE  = 63;
    /**
     * @hide
     */
    ...
    /**
     * A constant describing the gesture closing to face when answer the calling.
     *
     * @internal
     * @hide
     *
     */
    public static final int TYPE_ANSWER_CALL  = 64;
    /**
     * @hide
     */
    public static final String STRING_TYPE_ANSWERCALL = "android.sensor.answer_call";

    /* TYPE_GEOFENCE - defined as type 65 in the HAL is not exposed to
     * applications. There are parts of the framework that require the sensors
     * to be in the same order as the HAL. Skipping this sensor
     */

    /**
     * A constant describing the changes of floor counts.
     *
     * @internal
     * @hide
     *
     */
    public static final int TYPE_FLOOR_COUNTER = 66;
    /**
     * @hide
     */
    public static final String STRING_TYPE_FLOOR_COUNTER = "android.sensor.floor_count";

    /* TYPE_EKG, TYPE_PPG1, TYPE_PPG2 - defined as type 67, 68, 69 in the HAL is not exposed to
     * applications. These three types are for electrocardio related. There are parts of the
     * framework that require the sensors to be in the same order as the HAL. Skipping this sensor
     */

    /**
     * A constant describing the changes of rgbw.
     *
     * @internal
     * @hide
     *
     */
    public static final int TYPE_RGBW = 70;
    /**
     * @hide
     */
    public static final String STRING_TYPE_RGBW = "android.sensor.rgbw";
