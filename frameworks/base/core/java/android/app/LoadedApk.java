...
public final class LoadedApk {
     ...
     * Set to true if the application is an operator app under /vendor/operator/app or /cutomer/app
     */
    private static final int FLAG_EX_OPERATOR = 1 << 0;
    ...
    private void createOrUpdateClassLoaderLocked(List<String> addedPaths) {
        ...
        /// M: Should not be bundledApp to find "vndk" namespace for vendor apks
        boolean isBundledApp = (mApplicationInfo.isSystemApp()
                && !mApplicationInfo.isUpdatedSystemApp())
                || (mApplicationInfo.flagsEx & FLAG_EX_OPERATOR) != 0;
