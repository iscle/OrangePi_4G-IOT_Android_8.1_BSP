...
public final class WebViewFactory {
    ...
    private static final String CHROMIUM_WEBVIEW_PERMISSION_CHECK =
            "checkPermissionWithSpecialUid";
    ...
    static WebViewFactoryProvider getProvider() {
        synchronized (sProviderLock) {
            ...
            try {
                ...
                if (!hasPermission(providerClass, uid)) {
    ...
    private static Context getWebViewContextAndSetProvider() throws MissingWebViewPackageException {
        ...
        try {
            ...
            /// M: MTK Browser will try MTK WebView if exist @{
            try {
                Method getDefinedWebViewPackageName =
                    initialApplication.getClass().getMethod("getDefinedWebViewPackageName");
                String wpackageName =
                     (String) getDefinedWebViewPackageName.invoke(initialApplication);
                if (wpackageName != null) {
                    PackageInfo packageInfo =
                ...
                Log.e(LOGTAG, "No such method for getDefinedWebViewPackageName: " + e);
            } catch (IllegalAccessException e) {
                Log.e(LOGTAG, "Illegal access for getDefinedWebViewPackageName:" + e);
            } catch (InvocationTargetException e) {
                Log.e(LOGTAG, "Invocation target exception for getDefinedWebViewPackageName: " + e);
            } catch (PackageManager.NameNotFoundException e) {
    ...
    private static boolean hasPermission(Class<WebViewFactoryProvider> providerClass,
            final int uid) {
        if (uid == android.os.Process.ROOT_UID || uid == android.os.Process.SYSTEM_UID
            ...
            try {
                staticFactory = providerClass.getMethod(
                        CHROMIUM_WEBVIEW_PERMISSION_CHECK, String.class);
                checkResult = (boolean)
                        staticFactory.invoke(null, callPackage);
            } catch (Exception e) {
                Log.e(LOGTAG, "error checking permission:", e);
            }
            return checkResult;
        }
        return true;
