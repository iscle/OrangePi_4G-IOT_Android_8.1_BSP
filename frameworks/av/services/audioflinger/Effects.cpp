...
#if defined(MTK_AUDIO_DEBUG)
            String8 fileName;
            if (AudioDump::getProperty(AudioParameter::PROP_AUDIO_DUMP_EFFECT)) {
                fileName = String8::format("%s_session%d_%d_in.pcm",
                    AudioParameter::af_effect_pcm, mSessionId, mId);
                AudioDump::threadDump(fileName, mConfig.inputCfg.buffer.s16,
                    ...
                    * audio_bytes_per_sample((audio_format_t)mConfig.inputCfg.format),
                    (audio_format_t)mConfig.inputCfg.format, mConfig.inputCfg.samplingRate, FCC_2);
            }
#endif // MTK_AUDIO_DEBUG
            ...
            if (AudioDump::getProperty(AudioParameter::PROP_AUDIO_DUMP_EFFECT)) {
                ...
                AudioDump::threadDump(fileName, mConfig.outputCfg.buffer.s16,
                    ...
                    * audio_bytes_per_sample((audio_format_t)mConfig.outputCfg.format),
                    (audio_format_t)mConfig.outputCfg.format, mConfig.outputCfg.samplingRate, FCC_2);
            }
#endif // MTK_AUDIO_DEBUG
        } else {
