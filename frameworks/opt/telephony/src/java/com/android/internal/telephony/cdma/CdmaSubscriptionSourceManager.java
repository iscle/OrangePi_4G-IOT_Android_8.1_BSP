...
public class CdmaSubscriptionSourceManager extends Handler {
    ...
    // MTK-START
    protected /*private*/static final int EVENT_SUBSCRIPTION_STATUS_CHANGED      = 4;
    // MTK-END
    ...
    // MTK-START
    protected /*private*/static CdmaSubscriptionSourceManager sInstance;
    protected /*private*/static final Object sReferenceCountMonitor = new Object();
    protected /*private*/static int sReferenceCount = 0;

    // ***** Instance Variables
    protected /*private*/ CommandsInterface mCi;
    protected /*private*/ RegistrantList mCdmaSubscriptionSourceChangedRegistrants
            = new RegistrantList();
    // MTK-END
