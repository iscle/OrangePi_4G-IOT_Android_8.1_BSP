...
public class ImsSMSDispatcher extends SMSDispatcher {
    ...
    public ImsSMSDispatcher(Phone phone, SmsStorageMonitor storageMonitor,
        ...
        mCdmaDispatcher = TelephonyComponentFactory.getInstance().makeCdmaSMSDispatcher(phone,
                usageMonitor, this);
        // MTK-END
        ...
        mGsmDispatcher = TelephonyComponentFactory.getInstance().makeGsmSMSDispatcher(phone,
                usageMonitor, this, mGsmInboundSmsHandler);
