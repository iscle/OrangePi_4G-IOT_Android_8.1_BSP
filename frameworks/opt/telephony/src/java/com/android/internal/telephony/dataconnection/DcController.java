...
public class DcController extends StateMachine {
    ...
    protected ArrayList<DataConnection> mDcListAll = new ArrayList<DataConnection>();
    protected HashMap<Integer, DataConnection> mDcListActiveByCid =
     ...
     */
    protected final int DATA_CONNECTION_ACTIVE_PH_LINK_INACTIVE = 0;
    protected final int DATA_CONNECTION_ACTIVE_PH_LINK_DORMANT = 1;
    protected final int DATA_CONNECTION_ACTIVE_PH_LINK_UP = 2;
    ...
    protected volatile boolean mExecutingCarrierChange;
    ...
    public static DcController makeDcc(Phone phone, DcTracker dct, Handler handler) {
        ...
        DcController dcc = telephonyComponentFactory.makeDcController("Dcc", phone, dct, handler);
        /// @}
        dcc.start();
        return dcc;
    }
