...
public class UiccCard {
    ...
    protected PinState mUniversalPinState;
    protected int mGsmUmtsSubscriptionAppIndex;
    protected int mCdmaSubscriptionAppIndex;
    protected int mImsSubscriptionAppIndex;
    ...
    //MTK START: add-on
    protected RadioState mLastRadioState =  RadioState.RADIO_UNAVAILABLE;
    protected UiccCarrierPrivilegeRules mCarrierPrivilegeRules;
    ...
    //MTK START: add-on
    protected static final int EVENT_CARD_REMOVED = 13;
    protected static final int EVENT_CARD_ADDED = 14;
    //MTK END
    ...
    //MTK START: add-on
    protected static final int EVENT_SIM_IO_DONE = 19;
    protected static final int EVENT_CARRIER_PRIVILEGES_LOADED = 20;
    //MTK END
    ...
    //MTK START: add-on
    protected void createAndUpdateCatServiceLocked() {
    //MTK-EDN
    ...
    //MTK START: add-on
    protected int checkIndexLocked(int index, AppType expectedAppType, AppType altExpectedAppType) {
    //MTK END
