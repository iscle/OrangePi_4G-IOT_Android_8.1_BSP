...
public class RuimRecords extends IccRecords {
    ...
    // MTK-START
    protected /*private*/ byte[] mEFpl = null;
    protected /*private*/ byte[] mEFli = null;
    protected /*private*/ boolean mCsimSpnDisplayCondition = false;
    protected /*private*/ String mMdn;
    // MTK-END
    private String mMin;
    ...
    // ***** Event Constants
    // MTK-START
    protected /*private*/ static final int EVENT_GET_IMSI_DONE = 3;
    // MTK-END
    ...
    // MTK-START
    protected /*private*/ void handleRuimRefresh(IccRefreshResponse refreshResponse) {
    // MTK-END
