...
PRODUCT_NAME := full_k53v1_bsp_gmo_1g
PRODUCT_DEVICE := k53v1_bsp_gmo_1g
PRODUCT_MODEL := k53v1_bsp_gmo_1g
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k53v1_bsp_gmo_1g_debug_defconfig
else
KERNEL_DEFCONFIG ?= k53v1_bsp_gmo_1g_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k53v1_bsp_gmo_1g
LK_PROJECT ?= k53v1_bsp_gmo_1g
TRUSTY_PROJECT ?= k53v1_bsp_gmo_1g
