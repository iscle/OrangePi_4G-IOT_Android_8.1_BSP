...
PRODUCT_NAME := full_k53v1_bsp
PRODUCT_DEVICE := k53v1_bsp
PRODUCT_MODEL := k53v1_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k53v1_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= k53v1_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k53v1_bsp
LK_PROJECT ?= k53v1_bsp
TRUSTY_PROJECT ?= k53v1_bsp
