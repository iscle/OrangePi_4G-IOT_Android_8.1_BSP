...
struct ufs_ioctl_query_data {
	 ...
	 * Note that only below opcodes are supported:
	 * UPIU_QUERY_OPCODE_READ_DESC,
	 * UPIU_QUERY_OPCODE_READ_ATTR,
	 * UPIU_QUERY_OPCODE_WRITE_ATTR,
	 * UPIU_QUERY_OPCODE_READ_FLAG.
	 * All other query_opcode would be considered invalid.
	 ...
	 * Please check ufs-mtk-ioctl-private.h for the definition of it.
	 */
	__u8 idn;
	__u8 idx;
	/*
