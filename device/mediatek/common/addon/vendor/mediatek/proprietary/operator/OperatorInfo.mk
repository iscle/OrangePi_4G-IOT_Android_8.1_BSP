...
define include_regional_op_pack_config
    $(eval OP_PATH     := $(subst _,/,$(1)))
    -include $(MTK_ROOT_SOURCE_OPERATOR)/$(OP_PATH)/optr_apk_config.mk
endef
...
ifneq ($(OPTR_SPEC_SEG_DEF),NONE)
   ...
   ifdef MTK_CARRIEREXPRESS_PACK
     ifneq ($(strip $(MTK_CARRIEREXPRESS_PACK)),no)
       $(foreach OP_SPEC, $(MTK_REGIONAL_OP_PACK), $(eval $(call include_regional_op_pack_config, $(OP_SPEC))))
     else
