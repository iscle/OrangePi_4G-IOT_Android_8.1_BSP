...
int g_TpVirtualKey[] = {TOUCH_KEY_BACK , TOUCH_KEY_HOME, TOUCH_KEY_MENU};
...
int g_TpVirtualKeyDimLocal[MAX_KEY_NUM][4] = {{120,1350,BUTTON_W,BUTTON_H},
                                                    {360,1350,BUTTON_W,BUTTON_H},
                                                    {598,1350,BUTTON_W,BUTTON_H}};
