...
int gesture_enabled = 1;   //0 /* module switch */
...
s32 gesture_event_handler(struct input_dev * dev)
{
   ...
   if (len > GESTURE_MAX_POINT_COUNT) {
    ...
    printk("[gt1xx]doze_buf[0]=%d,  QUERYBIT(gestures_flag, ges_type)=%d\n", doze_buf[0],QUERYBIT(gestures_flag, ges_type));
