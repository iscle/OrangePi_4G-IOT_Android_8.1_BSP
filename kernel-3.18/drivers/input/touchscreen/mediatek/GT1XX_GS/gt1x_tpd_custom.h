...
//runyee zhou add begin
#ifdef CONFIG_GTP_HAVE_TOUCH_KEY
#define GTP_KEY_TAB	 { KEY_MENU, KEY_BACK ,KEY_HOMEPAGE, KEY_SEARCH}
#define GTP_MAX_KEY_NUM  4
#endif
//runyee zhou add end
#ifdef CONFIG_GTP_GESTURE_WAKEUP
   #define TPD_GESTURE_TAB {KEY_RIGHT,KEY_DOWN,KEY_UP,KEY_LEFT,KEY_O,KEY_M,KEY_E,KEY_C,KEY_W,KEY_S,KEY_Z,KEY_V,KEY_POWER}
