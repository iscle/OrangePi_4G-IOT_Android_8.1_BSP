...
int malloc_struct_DetailThreshold(void)
{
    ...
    test_data.mcap_detail_thr.scap_cb_test_on_max = (short (*)[RX_NUM_MAX])fts_malloc(NUM_MAX * sizeof(short));
    if (NULL == test_data.mcap_detail_thr.scap_cb_test_on_max) goto ERR;
    test_data.mcap_detail_thr.scap_cb_test_on_min = (short (*)[RX_NUM_MAX])fts_malloc(NUM_MAX * sizeof(short));
    if (NULL == test_data.mcap_detail_thr.scap_cb_test_on_min) goto ERR;
    test_data.mcap_detail_thr.scap_cb_test_off_max = (short (*)[RX_NUM_MAX])fts_malloc(NUM_MAX * sizeof(short));
    if (NULL == test_data.mcap_detail_thr.scap_cb_test_off_max) goto ERR;
    test_data.mcap_detail_thr.scap_cb_test_off_min = (short (*)[RX_NUM_MAX])fts_malloc(NUM_MAX * sizeof(short));
...
void OnInit_DThreshold_SCapCbTest(char *strIniFile)
{
    ...
    for (i = 0; i < 2; i++) {
        ...
        for (j = 0; j < dividerPos; j++) {
            if (',' == strValue[j]) {
                test_data.mcap_detail_thr.scap_cb_test_on_max[i][k] = (short)(fts_atoi(str_tmp));
                index = 0;
                memset(str_tmp, 0x00, sizeof(str_tmp));
                k++;
            } else {
    ...
    for (i = 0; i < 2; i++) {
        ...
        for (j = 0; j < dividerPos; j++) {
            if (',' == strValue[j]) {
                test_data.mcap_detail_thr.scap_cb_test_on_min[i][k] = (short)(fts_atoi(str_tmp));
                index = 0;
                memset(str_tmp, 0x00, sizeof(str_tmp));
                k++;
            } else {
    ...
    for (i = 0; i < 2; i++) {
        ...
        for (j = 0; j < dividerPos; j++) {
            if (',' == strValue[j]) {
                test_data.mcap_detail_thr.scap_cb_test_off_max[i][k] = (short)(fts_atoi(str_tmp));
                index = 0;
                memset(str_tmp, 0x00, sizeof(str_tmp));
                k++;
            } else {
    ...
    for (i = 0; i < 2; i++) {
        ...
        for (j = 0; j < dividerPos; j++) {
            if (',' == strValue[j]) {
                test_data.mcap_detail_thr.scap_cb_test_off_min[i][k] = (short)(fts_atoi(str_tmp));
                index = 0;
                memset(str_tmp, 0x00, sizeof(str_tmp));
                k++;
            } else {
